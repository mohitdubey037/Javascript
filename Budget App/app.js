...
var budgetController = (function () {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            index = ids.indexOf(id); //index will be -1 if the items is not found in the array which we are searching
        ...
        calculateBudget: function () {
            ...
            if (data.totals.inc > 0) {
                ...
                data.percentage = -1; //-1 basically means non-existant
            }
        },
        ...
        getPercentages: function () {
            ...
            return allPerc; //it is an array with all of the percentage
        },
...
var UIController = (function () {
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        num = Math.abs(num); //this is treated as regular variable in function
        num = num.toFixed(2);
    ...
    return {
        getInput: function () {
            return {
                type: document.querySelector(DOMStrings.inputType).value, //will be either true or false
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    const setUpEventListener = function () {
        ...
        document.addEventListener('keypress', function (event) {
            ...
            if (event.keyCode === 13 || event.which === 123) {
                ctrlAddItem();
            }
        });
    ...
    var ctrlDeleteItem = function (event) {
        ...
        if (itemId) {
            ...
            budgetCtrl.deleteItemFromUI(itemId);
